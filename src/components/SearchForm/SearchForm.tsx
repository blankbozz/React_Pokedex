    ...
    <form className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[20px]">
      <div>
        ...
        <select
          {...fieldGeneration}
          id="generation"
          className="bg-[#253641] capitalize border border-gray-300 text-white text-sm rounded-lg focus:ring-[#2E6CAE] focus:border-[#2E6CAE] block w-full p-2.5 "
        >
      ...
      <div>
        ...
        <input
          {...fieldKeyword}
          id="generation"
          className="bg-[#253641] border border-gray-300 text-white text-sm rounded-lg focus:ring-[#2E6CAE] focus:border-[#2E6CAE] block w-full p-2.5 "
        />
      </div>
    </form>
  );
